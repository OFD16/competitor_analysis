  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: DefaultTabController(
        initialIndex: 0, // Updated initialIndex to 0
        length: 3, // Updated length to 3
        child: Scaffold(
          appBar: AppBar(
            title: const Text('Etsy Rakip Analiz'),
            centerTitle: true,
            bottom: const TabBar(
              tabs: [
                Tab(
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        ...
        loading ? const CircularProgressIndicator() : Text(res2),
      ],
    );
  }
}
